...
$(document).ready(function(){
    $('.market-tab-list li').click(function(){
        if(!jQuery(this).hasClass('active')) {
            jQuery('.market-tab-list li.active').removeClass('active');
            jQuery(this).addClass('active');
        } else {
            jQuery(this).removeClass('active');
        }
        var inputValue = $(this).attr("data-tab-market");
        var targetBox = $("#" + inputValue);
        $(".market-content-box").not(targetBox).removeClass('active');
