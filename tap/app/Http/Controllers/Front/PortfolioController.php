...
class PortfolioController extends BaseController
{
    ...
    public function update(Request $request)
    {
        ...
        if (!$targetprofile) {
            return redirect()->back()->with('Error occurred while updating Profile.', 'error', true, true);
        }
        return redirect()->back()->with('success', 'Profile has been updated successfully', 'success', false, false);
    }
