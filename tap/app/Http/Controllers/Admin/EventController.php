                    ...
                    foreach ($importData_arr as $importData) {
                        ...
                        if (!empty($importData[0])) {
                            ...
                            foreach ($titleArr as $titleKey => $titleValue) {
                                ...
                                $insertData = array(
                                    "title" => $titleValue,
                                    "type" => isset($commaSeperatedCats) ? $commaSeperatedCats : null,
                                    "start_date" => date('Y-m-d', strtotime($importData[2])),
                                    "start_time" => isset($importData[3]) ? $importData[3] : null,
                                    "end_date" => date('Y-m-d', strtotime($importData[4])),
                                    "end_time" => isset($importData[5]) ? $importData[5] : null,
                                    "address" => isset($importData[6]) ? $importData[6] : null,
                                    "suburb" => isset($importData[7]) ? $importData[7] : null,
                                    "state" => isset($importData[8]) ? $importData[8] : null,
                                    "description" => isset($importData[9]) ? $importData[9] : null,
                                    "slug" => $slug,
                                    "link" => isset($importData[10]) ? $importData[10] : null,
                                    "cost" => isset($importData[11]) ? $importData[11] : null,
                                    "recurring" => isset($importData[12]) ? $importData[12] : null,
