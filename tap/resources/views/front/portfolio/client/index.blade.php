        ...
        <div class="row mt-0">
            <div class="col-12">
                <div class="edit-sec-top d-flex align-items-center">
                    ...
                    <a href="{{ route('front.portfolio.client.create') }}" class="add-btn-edit d-inline-block">
                                        ...
                                        <div class="portfolio-v4-content-list">
                                            <div class="portfolio-v4-client-flex">
                                                ...
                                                <div class="portfolio-v4-client-info">
                                                    ...
                                                    <p class="mb-0">Group : {{$item->group->group_name ?? ''}}</p>
                                                </div>
                                            </div>
                                            <div class="action justify-content-end">
                                                <a href="{{ route('front.portfolio.client.edit', $item->id) }}" title="Edit Profile"><i class="fa-solid fa-pen edit table-icon"></i></a>
                                                <a href="{{ route('front.client.detail', $item->id) }}"> <i class="fa-solid fa-eye edit table-icon"></i> </a>
