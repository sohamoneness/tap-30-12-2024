...
@section('title', 'Manage Private Article')
        ...
        <div class="row">
            <div class="col-md-8 mx-auto edit-basic-detail-content-wrap">
                ...
                <span class="top-form-btn">
                    <form action="{{ route('front.portfolio.private-articles.update') }}" method="POST" role="form"
                        ...
                        <div class="tile-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('title') is-invalid @enderror" type="number" name="total_words"
                                    id="title" value="{{ old('total_words',$portfolio->total_words) }}" />
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('title') is-invalid @enderror" type="number" name="budget"
                                    id="title" value="{{ old('budget',$portfolio->budget) }}" />
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('title') is-invalid @enderror" type="text" name="primary_keyword"
                                    id="title" value="{{ old('primary_keyword',$portfolio->primary_keyword) }}" />
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('title') is-invalid @enderror" type="text" name="secondary_keywords"
                                    id="title" value="{{ old('secondary_keywords',$portfolio->secondary_keywords) }}" />
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('title') is-invalid @enderror" type="text" name="seo_tool"
                                    id="title" value="{{ old('seo_tool',$portfolio->seo_tool) }}" />
                            ...
                            <div class="form-group">
                                <label class="control-label" for="actual_article">Actual Article<span class="m-l-5 text-danger">
                                    *</span></label>
                                <textarea type="text" class="form-control" rows="4" name="actual_article" id="short_desc">{{ old('actual_article',$portfolio->actual_article) }}</textarea>
                                @error('short_desc')
                                    <p class="small text-danger">{{ $message }}</p>
                                @enderror
                            </div><br>
                        ...
                        <div class="tile-footer">
                            ...
                            <a href="{{ route('front.portfolio.private-articles.index') }}" class="add-btn-edit d-inline-block secondary-btn"><i class="fa fa-fw fa-lg fa-chevron-left"></i> Back</a>
