...
@section('section')
    ...
    <section class="artiledetails_banner eventDetails">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="artiledetails_banner_text" style="display: none;">
                        <ul class="breadcumb_list mb-2 mb-sm-4">
                            <li><a href="{!! URL::to('') !!}">Home</a></li>
                            <li>/</li>
                            <li><a href="{!! URL::to('user/event') !!}">Event</a></li>
                            <li>/</li>
                            <li>
                                @if (is_array($event->type) && count($event->type) > 0)
                            </li>
                            <li>
                                @endif
                                @php
                        ...
                        <div class="col">
                            <ul class="articlecat">
                                ...
                                <li>
                                    ...
                                    <div class="share-btns">
                                        <div class="dropdown">
                                            <button class="share_button dropdown-toggle" type="button"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" onclick="myCustomFunction()">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right"
                                                aria-labelledby="dropdownMenuButton" id="eventShare">
                                                <div class="w-100 pl-2">
                                                    <div class="a2a_kit a2a_kit_size_32 a2a_default_style">
                                                        <a class="a2a_button_facebook"></a>
                                                        <a class="a2a_button_twitter"></a>
    ...
    <section class="art-dtls eventDetails">
        <div class="container-fluid">
            <div class="row">
                @if ($event->start_date)
                ...
                @if ($event->type)
                    <div class="col-lg-3 mb-4 mb-lg-0">
                        <div class="event_meta">
                            ...
                            <figcaption>
                                <h5> Type:</h5>
                                <h3>{{ ucwords( $event->eventCategory->title) }}</h3>
                            </figcaption>
                        </div>
                    </div>
                @endif
    ...
    <section class="relevant-event-section">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <p class="description">Vestibulum commodo lectus non sapien venenatis, id porta magna faucibus. Mauris tortor ex, rutrum porta velit eget, pulvinar maximus libero. Integer quis accumsan mi. Praesent vel ultrices magna, ornare hendrerit magna. Nulla non accumsan arcu, pharetra fermentum augue. Pellentesque imperdiet tellus sit amet lacus tincidunt, a venenatis mi convallis. Vestibulum rhoncus tellus nisi, quis vestibulum nulla feugiat sit amet. Ut vitae pretium nisl. Duis vitae vulputate nunc. Nullam vulputate, ipsum ut mollis efficitur, est lectus malesuada lorem, quis vestibulum mauris ante et leo. Vivamus vel dolor sit amet sapien tempor mattis.</p>
                </div>
            </div>
            ...
            <div class="row">
                @foreach ($latestevents as $eventProductkey => $data)
                    <div class="col-12 col-lg-4 col-md-6 mb-3 blog_list some-list-1">
                        {{-- <a href=""> --}}
                        <div class="card">
                            <a href="{{ route('front.event.details', $data->slug) }}" class="event_img">
                                @if(!empty($data->image))
