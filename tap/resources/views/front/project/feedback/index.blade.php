          ...
          <div class="heading row2 mt-0">
            <div class="pro-content-header-left">
              <ul class="list-unstyled p-0 m-0">
                  ...
                  <li><a href="{{ route('front.project.feedback.index', $data->slug) }}" class="active">Customer Feedback</a></li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <div class="comment-card">
              <div class="comment-card-flex">
                ...
                <div class="comment-card-section">
                  <form action="{{ route('front.project.feedback.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
