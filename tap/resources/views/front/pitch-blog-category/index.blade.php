              ...
              <table class="table mb-0">
                ...
                <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="text-muted"><small>@if($item->description != ''){{ substr($item->description,0,10) }}...@endif</small></p>
                                </td>
                                <td>
                                  <div class="action-panel">
                                    <a href="{{ route('front.user.pitch.blog.category.detail', $item->slug) }}" class="badge"> 
                                    ...
                                    <a href="{{ route('front.user.pitch.blog.category.edit', $item->id) }}" class="badge"> 
                                    ...
                                    <a href="{{ route('front.user.pitch.blog.category.delete', $item->id) }}" class="badge" onclick="return confirm('Are you sure?')"> 
    ...
    <div class="container">
        <div class="row my-3 justify-content-between">
            <div class="col-md-12 text-end mb-4">
                <a href="{{ route('front.user.pitch.blog.category.create') }}" class="add-btn-edit d-inline-block" style="padding: 6px 12px;">Create <i class="fa-solid fa-plus ps-1"></i></a>
            </div>
            <div class="col-md-3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center" width="120">
                                    <a href="{{ route('front.user.pitch.blog.category.detail', $item->slug) }}" class="badge bg-dark"> <i class="fas fa-eye"></i> </a>

                                    <a href="{{ route('front.user.pitch.blog.category.edit', $item->id) }}" class="badge bg-dark"> <i class="fas fa-edit"></i></a>

                                    <a href="{{ route('front.user.pitch.blog.category.delete', $item->id) }}" class="badge bg-danger" onclick="return confirm('Are you sure?')"> <i class="fas fa-trash"></i> </a>
                                </td>
                            </tr>
                            @empty
                            <tr>
