    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            ...
            <a class="btn btn-secondary" href="{{ route('admin.glossary.index') }}"><i
                ...
                <hr>
                <form action="{{ route('admin.glossary.store') }}" method="POST" role="form"
                    ...
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" rows="4" name="definition" id="definition">{{ old('definition') }}</textarea>
                        ...
                        <div class="form-group">
                            <label class="control-label" for="content">Detailed Explanation<span class="m-l-5 text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="frequency_of_use"
                                id="frequency_of_use" value="{{ old('frequency_of_use') }}" />
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="content">Frequency Description<span class="m-l-5 text-danger">*</span></label>
                            <textarea type="text" class="form-control" rows="4" name="frequency_description" id="frequency_description">{{ old('frequency_description') }}</textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="importance_of_term"
                                id="importance_of_term" value="{{ old('importance_of_term') }}" />
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="content">Importance Description<span class="m-l-5 text-danger">*</span></label>
                            <textarea type="text" class="form-control" rows="4" name="importance_description" id="importance_description">{{ old('importance_description') }}</textarea>
                        </div>
                        <div class="form-group">
