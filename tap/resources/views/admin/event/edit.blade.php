                ...
                <form action="{{ route('admin.event.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            <label class="control-label" for="category">Type <span class="m-l-5 text-danger">*</span></label>
                            <select name="type" id="type" class="form-control @error('type') is-invalid @enderror">
                                <option value=""  hidden selected>Select </option>
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}" {{ ( $category->id == $event->type ) ? 'selected' : '' }}>{{ucwords($category->title) }}</option>
                                @endforeach
                            </select>
                            ...
                            *</span></label>
                            ...
                            <select name="type" id="type" class="form-control @error('type') is-invalid @enderror">
                                ...
                                @foreach ($type as $item)
                                    <option value="{{ $item->id }}" {{ ( $item->id == $item->type ) ? 'selected' : '' }}>{{ucwords($category->title) }}</option>
                                @endforeach
                            </select>
                            @error('type') <p class="small text-danger">{{ $message }}</p> @enderror
                            {{-- <div class="row">
                        ...
                        <div id="typePerson"> --}}
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('suburb') is-invalid @enderror" type="text" name="suburb" id="suburb" value="{{ old('suburb',$event->suburb) }}" />
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('state') is-invalid @enderror" type="text" name="state" id="state" value="{{ old('state',$event->state) }}" />
                            ...
                            <div id="yes">
                                <div class="form-group">
                                    <select name="recurring" id="skim"
                                        ...
                                        <option value="annual" {{ 'annual' == $event->recurring  ? 'selected' : '' }}>Annual</option>
                                        <option value="TBD" {{ 'TBD' == $event->recurring  ? 'selected' : '' }}>TBD</option>
                                        <option value="every-2-years" {{ 'every-2-years' == $event->recurring  ? 'selected' : '' }}>Every 2 years</option>
                                        <option value="every-4-years" {{ 'every-4-years' == $event->recurring  ? 'selected' : '' }}>Every 4 Years</option>
                                    </select>
                                </div>
                            </div>
                        </div>
