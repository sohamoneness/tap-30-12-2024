...
<aside class="app-sidebar">
    <ul class="app-menu">
        ...
        <div id="collapseTwelve" class="collapse @if (request()->is('admin/market*') ||
            ...
            <!---  Type management ---->
            <li>
                <a class="app-menu__item {{ request()->is('admin/market/type*') ? 'active' : '' }} {{ sidebar_open(['admin.market.type']) }}" href="{{ route('admin.market.type.index') }}">
        ...
        <div id="collapseFifteen" class="collapse @if (request()->is('admin/tools*') ||
            ...
            <li>
             ...
             <!---  sub Category ---->
             <li>
                <a class="app-menu__item {{ request()->is('admin/tools/sub/category*') ? 'active' : '' }} {{ sidebar_open(['admin.tools.sub.category.index']) }}"
                    href="{{ route('admin.tools.sub.category.index') }}">
                    <i class="app-menu__icon fa fa-sitemap"></i>
            ...
            <!--- Features Management --->
            <li>
                <a class="app-menu__item {{ request()->is('admin/tools/feature*') ? 'active' : '' }} {{ sidebar_open(['admin.feature']) }}"
        ...
        {{-- - footer - --}}
            ...
            <li>
                <a class="app-menu__item {{ request()->is('admin/faq*') ? 'active' : '' }}"
                    href="{{ route('admin.faq.index') }}"><i class="app-menu__icon fa fa-cogs"></i>
                    <span class="app-menu__label">FAQ Management</span>
                </a>
            </li>
            <li>
                <a class="app-menu__item {{ request()->is('admin/glossarytype*') ? 'active' : '' }}"
                    href="{{ route('admin.glossarytype.index') }}"><i class="app-menu__icon fa fa-cogs"></i>
                    <span class="app-menu__label">Glossary Type Management</span>
                </a>
            </li>
            <li>
                <a class="app-menu__item {{ request()->is('admin/glossary*') ? 'active' : '' }}"
                    href="{{ route('admin.glossary.index') }}"><i class="app-menu__icon fa fa-cogs"></i>
                    <span class="app-menu__label">Glossary Management</span>
                </a>
            </li>
            <li>
