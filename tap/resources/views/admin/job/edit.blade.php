                ...
                <form action="{{ route('admin.job.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="control-label" for="source">Source (Optional)</label>
                                    <select class="filter_select form-control" name="source" id="source">
                                        <option value="">Select an option</option>
                                        <option value="indeed" {{ $data->source == 'indeed' ? 'selected' : '' }}>Indeed
                                        </option>
                                        <option value="problogger" {{ $data->source == 'problogger' ? 'selected' : '' }}>Problogger
                                        </option>
                                        <option value="medabistro" {{$data->source == 'medabistro' ? 'selected' : '' }}>Mediabistro
                                        </option>
                                        <option value="journalism" {{ $data->source == 'journalism' ? 'selected' : '' }}>
                                            Journalismjobs
                                        </option>
                                        <option value="freelance" {{ $data->source == 'freelance' ? 'selected' : '' }}> Freelancewritinggigs
                                        </option>
                                        <option value="blogging" {{ $data->source == 'blogging' ? 'selected' : '' }}> BloggingPro
                                        </option>
                                    </select>
                                    @error('source')
                                        <p class="small text-danger">{{ $message }}</p>
