                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select class="filter_select form-control" name="source" id="source">
                                        ...
                                        <option value="indeed" {{ old('source') == 'indeed' ? 'selected' : '' }}>Indeed
                                        </option>
                                        <option value="problogger" {{ old('source') == 'problogger' ? 'selected' : '' }}>Problogger
                                        </option>
                                        <option value="medabistro" {{ old('source') == 'medabistro' ? 'selected' : '' }}>Mediabistro
                                        </option>
                                        <option value="journalism" {{ old('source') == 'journalism' ? 'selected' : '' }}>
                                            Journalismjobs
                                        </option>
                                        <option value="freelance" {{ old('source') == 'freelance' ? 'selected' : '' }}> Freelancewritinggigs
                                        </option>
                                        <option value="blogging" {{ old('source') == 'blogging' ? 'selected' : '' }}> BloggingPro
                                        </option>
                                    </select>
                                    @error('source')
                                        <p class="small text-danger">{{ $message }}</p>
