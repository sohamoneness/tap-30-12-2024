...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-8 mx-auto">
            ...
            <a class="btn btn-secondary" href="{{ route('admin.feature.index') }}"><i
                ...
                <form action="{{ route('admin.feature.update') }}" method="POST" role="form"
                    ...
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('title') is-invalid @enderror" type="text" name="title"
                                ...
                                id="title" value="{{ old('title',$feature->title) }}" />
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('sub_title') is-invalid @enderror" type="text" name="sub_title"
                                ...
                                id="sub_title" value="{{ old('sub_title',$feature->sub_title) }}" />
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="news_letter_section_title"

                                id="news_letter_section_title" value="{{ old('news_letter_section_title',$feature->news_letter_section_title) }}" />
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="news_letter_section_button_name"

                                id="news_letter_section_button_name" value="{{ old('news_letter_section_button_name',$feature->news_letter_section_button_name) }}" />
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="faq_section_title"

                                id="faq_section_title" value="{{ old('faq_section_title',$feature->faq_section_title) }}" />
                        ...
                        <tbody id="time-tbody2">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input class="form-control" type="text" name="feature_details_title[]" id="" value="{{$detail->title}}" />
                                ...
                                <td>
                                    ...
                                    <input class="form-control" type="text" name="feature_details_sub_title[]" id="" value="{{$detail->sub_title}}" />
                                ...
                                <td>
                                    ...
                                    <textarea type="text" class="form-control feature_details_description" rows="4" name="feature_details_description[]" id="">{{$detail->description}}</textarea>
                                ...
                                <td>
                                    ...
                                    <input class="form-control" type="text" name="feature_details_button_name[]" id="" value="{{$detail->button_name}}" />
                                ...
                                <td>
                                    ...
                                    <input class="form-control" type="text" name="feature_details_button_link[]" id="" value="{{$detail->button_link}}" />
                        ...
                        <tbody id="time-tbody1">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input class="form-control" type="text" name="feature_faq_questions[]" id="" value="{{$faq->question}}" />
                                ...
                                <td>
                                    ...
                                    <textarea type="text" class="form-control feature_faq_answers" rows="4" name="feature_faq_answers[]" id="">{{$faq->answer}}</textarea>
                    ...
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label" for="content">Join Community Section Title<span class="m-l-5 text-danger">*</span></label>
                             ...
                             <input class="form-control @error('join_cummunity_section_title') is-invalid @enderror" type="text" name="join_cummunity_section_title"

                                id="join_cummunity_section_title" value="{{old('join_cummunity_section_title',$feature->join_cummunity_section_title) }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label" for="content">Join Community Section Sub Title<span class="m-l-5 text-danger">*</span></label>
                             ...
                             <input class="form-control @error('join_cummunity_section_sub_title') is-invalid @enderror" type="text" name="join_cummunity_section_sub_title"

                                id="join_cummunity_section_sub_title" value="{{ old('join_cummunity_section_sub_title',$feature->join_cummunity_section_sub_title) }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label" for="content">Join Community Section Button Name<span class="m-l-5 text-danger">*</span></label>
                             ...
                             <input class="form-control @error('join_cummunity_section_button_name') is-invalid @enderror" type="text" name="join_cummunity_section_button_name"

                                id="join_cummunity_section_button_name" value="{{ old('join_cummunity_section_button_name',$feature->join_cummunity_section_button_name) }}" />
