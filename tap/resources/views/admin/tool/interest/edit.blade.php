                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            <div class="select-floating-admin">
                                ...
                                <select name="cat_id" id="cat_id"
                                    class="filter_select form-control @error('cat_id') is-invalid @enderror">
                            ...
                            <div class="select-floating-admin">
                                ...
                                <select name="sub_cat_id" id="sub_cat_id"
                                    ...
                                    @foreach ($subcategories as $category)
                                        <option value="{{ $category->id }}"
                                            {{ $category->id == $data->sub_cat_id ? 'selected' : '' }}>
                                            {{ ucwords($category->title) }}</option>
                                    @endforeach
                                </select>
                                @error('sub_cat_id')
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('feature') is-invalid @enderror" type="text" name="feature"
                                id="feature">{{ old('feature', $data->feature) }}</textarea>
                            @error('feature')
                                {{ $message ?? '' }}
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('pros') is-invalid @enderror" type="text" name="pros"
                                id="pros">{{ old('pros', $data->pros) }}</textarea>
                            @error('pros')
                                {{ $message ?? '' }}
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('cons') is-invalid @enderror" type="text" name="cons"
                                id="cons">{{ old('cons', $data->cons) }}</textarea>
                            @error('cons')
                                {{ $message ?? '' }}
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('price') is-invalid @enderror" type="text" name="price"
                                id="price">{{ old('price', $data->price) }}</textarea>
                            @error('price')
                                {{ $message ?? '' }}
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('link') is-invalid @enderror" type="text" name="link"
                                id="link">{{ old('link', $data->link) }}</textarea>
                            @error('link')
                                {{ $message ?? '' }}
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('affiliate_programme') is-invalid @enderror" type="text" name="affiliate_programme"
                                id="affiliate_programme">{{ old('affiliate_programme', $data->affiliate_programme) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('affiliate_programme_link') is-invalid @enderror" type="text" name="affiliate_programme_link"
                                id="affiliate_programme_link">{{ old('affiliate_programme_link', $data->affiliate_programme_link) }}</textarea>
                        ...
                        <div class="form-group">
                            <table class="search_table" id="table">
                                ...
                                @php
                                    $i=$key+1;
                                @endphp
                                <tr id="benefitsTr{{$i}}" class="tr_benefits">
                                    <input type="hidden" name="benefits[{{$i}}][tool_benefit_id]" value="{{$benefit->id}}">
                                    <td>
                                        <label class="control-label" for="name">Title <span class="m-l-5 text-danger">*</span></label>
                                        <input class="form-control" type="text" name="benefits[{{$i}}][title]" id="d_title{{$i}}" value="{{ $benefit->title }}" />
                                    </td>
                                    <td>
                                        <label>Description <span class="m-l-5 text-danger">*</span></label>
                                        <textarea type="text" class="form-control tool_benefits_description" rows="4" name="benefits[{{$i}}][description]" id="ben_description{{$i}}">{{ $benefit->description }}</textarea>
                                    </td>
                                    <td>
                                        <a href="javascript:void(0);" class="btn btn-submit addBenefitBtn" id="d_add{{$i}}" >Add</a>
                                        <a href="javascript:void(0);" class="btn btn-danger removeBenefitBtn" onclick="removeRowBenefit({{$i}})" id="ben_remove{{$i}}" >Remove</a>
                        ...
                        <div class="form-group">
                            <table class="search_table" id="table">
                                ...
                                @forelse($usecases as $key => $usecase)
                                @php
                                    $i=$key+1;
                                @endphp
                                <tr id="useCaseTr{{$i}}" class="tr_usecases">
                                    <input type="hidden" name="usecases[{{$i}}][tool_usecase_id]" value="{{$usecase->id}}">
                                    <td>
                                        <label class="control-label" for="name">Title <span class="m-l-5 text-danger">*</span></label>
                                        <input class="form-control" type="text" name="usecases[{{$i}}][title]" id="" value="{{ $usecase->title }}" />
                                    </td>
                                    <td>
                                        <label>Description <span class="m-l-5 text-danger">*</span></label>
                                        <textarea type="text" class="form-control tool_usecases_description" rows="4" name="usecases[{{$i}}][description]" id="">{{ $usecase->description }}</textarea>
                                    </td>
                                    <td>
                                        <label class="control-label" for="name">Url </label>
                                        <input class="form-control" type="text" name="usecases[{{$i}}][url]" id="" value="{{ $usecase->url }}" />
                                    </td>
                                    <td>
                                        <a href="javascript:void(0);" class="btn btn-submit addUsecaseBtn" id="" >Add</a>
                                        <a href="javascript:void(0);" class="btn btn-danger removeBenefitBtn" onclick="removeRowUsecase({{$i}})" id="" >Remove</a>
                                    </td>
                                </tr>
                                @empty
                        ...
                        <div class="form-group">
                            <table class="search_table" id="table">
                                ...
                                @forelse($howtouses as $key => $howtouse)
                                @php
                                    $i=$key+1;
                                @endphp
                                <tr id="howtoUseTr{{$i}}" class="tr_howtouses">
                                    <input type="hidden" name="howtouses[{{$i}}][tool_howtouse_id]" value="{{$howtouse->id}}">
                                    <td>
                                        <label class="control-label" for="name">Title <span class="m-l-5 text-danger">*</span></label>
                                        <input class="form-control" type="text" name="howtouses[{{$i}}][title]" id="d_title{{$i}}" value="{{ $howtouse->title }}" />
                                    </td>
                                    <td>
                                        <label>Description <span class="m-l-5 text-danger">*</span></label>
                                        <textarea type="text" class="form-control " rows="4" name="howtouses[{{$i}}][description]" id="">{{ $howtouse->description }}</textarea>
                                    </td>
                                    <td>
                                        <label class="control-label" for="name">Icon  </label>
                                        <input class="form-control" type="file" name="howtouses[{{$i}}][icon]" id=""  />
                                    </td>
                                    <td>
                                        <a href="javascript:void(0);" class="btn btn-submit addHowtouseBtn" id="" >Add</a>
                                        <a href="javascript:void(0);" class="btn btn-danger removeHowtouseBtn" onclick="removeRowHowtouse({{$i}})" id="" >Remove</a>
                                        <a href="{{ asset($howtouse->icon) }}" class="btn btn-submit" target="_blank" >View Image</a>
                                    </td>
                                </tr>
                                @empty
                        ...
                        <div class="form-group">
                            <table class="search_table" id="table">
                                ...
                                @forelse($integration_compatibilities as $key => $compatibility)
                                @php
                                    $i=$key+1;
                                @endphp
                                <tr id="compatibilitiesTr{{$i}}" class="tr_compatibilities">
                                    <input type="hidden" name="integration_compatibilities[{{$i}}][tool_compatibility_id]" value="{{$compatibility->id}}">
                                    <td>
                                        <label class="control-label" for="name">Title <span class="m-l-5 text-danger">*</span></label>
                                        <input class="form-control" type="text" name="integration_compatibilities[{{$i}}][title]" value="{{ $compatibility->title }}" />
                                    </td>
                                    <td>
                                        <label>Description <span class="m-l-5 text-danger">*</span></label>
                                        <textarea type="text" class="form-control " rows="4" name="integration_compatibilities[{{$i}}][description]" >{{ $compatibility->description }}</textarea>
                                    </td>
                                    <td>
                                        <a href="javascript:void(0);" class="btn btn-submit addCompatibilityBtn" >Add</a>
                                        <a href="javascript:void(0);" class="btn btn-danger removeCompatibilityBtn" onclick="removeRowCompatibility({{$i}})"  >Remove</a>
                        ...
                        <div class="form-group">
                            <table class="search_table" id="table">
                                ...
                                <tr id="plansTr{{$key}}" class="tr_plans">
                                    <input type="hidden" name="plans[{{$key}}][tool_plan_id]" value="{{ old('plans.'.$key.'.tool_plan_id') }}">
                                ...
                                @php
                                    $i=$key+1;
                                @endphp
                                <tr id="plansTr{{$i}}" class="tr_plans">
                                    <input type="hidden" name="plans[{{$i}}][tool_plan_id]" value="{{$plan->id}}">
                                    <td>
                                        <label class="control-label" for="name">Title <span class="m-l-5 text-danger">*</span></label>
                                        <input class="form-control" type="text" name="plans[{{$i}}][title]" value="{{ $plan->title }}" />
                                    </td>
                                    <td>
                                        <label>Short Description <span class="m-l-5 text-danger">*</span></label>
                                        <textarea type="text" class="form-control " rows="4" name="plans[{{$i}}][short_description]" >{{ $plan->short_description }}</textarea>
                                    </td>
                                    <td>
                                        <label>Long Description </label>
                                        <textarea type="text" class="form-control " rows="4" name="plans[{{$i}}][long_description]" >{{ $plan->long_description }}</textarea>
                                    </td>
                                    <td>
                                        <label class="control-label" >Amount <span class="m-l-5 text-danger">*</span></label>
                                        <input class="form-control" type="text" name="plans[{{$i}}][amount]" value="{{ $plan->amount }}" />
                                    </td>
                                    <td>
                                        <label class="control-label" >Link <span class="m-l-5 text-danger">*</span></label>
                                        <input class="form-control" type="text" name="plans[{{$i}}][link]" value="{{ $plan->link }}" />
                                    </td>
                                    <td>
                                        <a href="javascript:void(0);" class="btn btn-submit addPlanBtn" >Add</a>
                                        <a href="javascript:void(0);" class="btn btn-danger removePlanBtn" onclick="removeRowPlan({{$i}})"  >Remove</a>
                                        
                                    </td>
                                </tr>
                                @empty
                                <tr id="plansTr1" class="tr_plans">
                                    <input type="hidden" name="plans[1][tool_plan_id]" value="">
                                    <td>
                                        <label class="control-label" for="name">Title <span class="m-l-5 text-danger">*</span></label>
...
@push('scripts')
    ...
    <script>
        ...
        @else
            var totalBenefits = "{{ count($benefits) }}";
            totalBenefits = parseInt(totalBenefits);
            if(totalBenefits == 0){
                var iBenefits = 2;
            } else {
        ...
        @else
            var totalusecases = "{{ count($usecases) }}";
            // alert(totalusecases)
            totalusecases = parseInt(totalusecases);
        ...
        @else
            var totalhowtouses = "{{ count($howtouses) }}";
        ...
        @else
            var totalcompatibilities = "{{ count($integration_compatibilities) }}";
            
            totalcompatibilities = parseInt(totalcompatibilities);
            if(totalcompatibilities == 0){
        ...
        $(document).on('click','.addPlanBtn',function(){
            ...
            var htmlPlans = `<tr id="plansTr`+iPlan+`" class="tr_plans">
                                    <input type="hidden" name="plans[`+iPlan+`][tool_plan_id]" value="">
                                    <td>
                                        <label class="control-label" for="name">Title <span class="m-l-5 text-danger">*</span></label>
