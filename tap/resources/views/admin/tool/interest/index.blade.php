        ...
        <div class="row w-100">
            ...
            <div class="col-md-6 text-right">
                ...
                <a href="#csvUploadModal" data-toggle="modal" class="btn btn-primary "><i class="fa fa-cloud-upload"></i> CSV
                    Upload</a>
                <a href="{{ route('admin.tools.AreaOfInterest.data.csv.export') }}" class="btn btn-primary "><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('admin.tools.AreaOfInterest.data.csv.store')}}" enctype="multipart/form-data" id="fileCsvUploadForm">
                        @csrf
                        ...
                        <button type="submit" class="btn btn-sm btn-primary" id="csvImportBtn">Import <i class="fas fa-upload"></i></button>
                         <p><a href="{{URL::to('/')}}/uploads/admin/csvexample/tool.csv" target="_blank">
